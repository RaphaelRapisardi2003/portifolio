  ...
  projects: [
    {
      ...
      titleEn: "Viper",
      titlePt: "Viper",
      categoryEn: "Frontend · Fashion E-commerce",
      categoryPt: "Frontend · E-commerce de Moda",
      descriptionEn: "Premium fashion e-commerce for Viper Milano, a fictional Italian luxury brand. Built entirely with HTML5, CSS3, and Vanilla JS — no frameworks. Features a custom editorial identity: hero carousel with local photography, brand manifesto with typographic watermark, asymmetric lookbook grid, fragrance section (Il Profumo), and a Quem Somos split layout. Includes a custom cursor with lerp animation, sticky mega menu, mobile drawer, and scroll reveal.",
      descriptionPt: "E-commerce de moda premium para a Viper Milano, grife italiana fictícia de alto padrão. Desenvolvido inteiramente com HTML5, CSS3 e Vanilla JS — sem frameworks. Possui identidade editorial própria: hero carousel com foto local, seção Manifesto com watermark tipográfico, grid de lookbook assimétrico, seção de perfumes (Il Profumo) e layout Quem Somos em split escuro. Cursor personalizado com animação lerp, mega menu sticky, drawer mobile e scroll reveal.",
      tech: ["HTML5", "CSS3", "JavaScript"],
      metricsEn: ["Custom cursor with lerp animation", "Asymmetric editorial lookbook grid", "Fully responsive · 1440 / 1024 / 768px"],
      metricsPt: ["Cursor personalizado com animação lerp", "Grid de lookbook editorial assimétrico", "Totalmente responsivo · 1440 / 1024 / 768px"],
      githubUrl: "https://github.com/RaphaelRapisardi2003/Viper",
      imageUrl: "/screenshots/viper.svg",
    },
    {
      id: "proj-neeko",
      titleEn: "Neeko",
